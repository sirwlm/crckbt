...
SITE_URL = 'https://bot.crck.me'
GITHUB_URL = 'https://github.com/sirwlm/crkbot'
...
PRAW_USER_AGENT = 'python:fabulous-discord-fetcher'
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'crck.me', 'bot.crck.me']
